...
pub async fn getmenu(vendorid : &i32, deviceid : &i32, productname : &str, role :&str, menu : &str,accessrights : &Option<String>, locale : &str){
    ...
    for x in menus {
        let trans = e.resolve_textid(x.name.textid.as_str(),locale);
